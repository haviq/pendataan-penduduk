...
<head>
<meta charset="UTF-8">
<title>Cetak Bulk KK</title>
<style>
*{box-sizing:border-box;margin:0;padding:0}
@page{size:A5 landscape;margin:1.2cm 1.5cm}
body{font-family:'Arial',sans-serif;font-size:9pt;color:#000;background:#fff}
.kk-page{page-break-after:always}
.kk-page:last-child{page-break-after:avoid}
...
<div class="kk-page">
  ...
  <div class="info-grid">
    ...
    <div class="info-item"><span class="lbl">Desa</span><span class="val">Gondang, Cangkringan, Sleman</span></div>
  </div>
  <table>
    <thead>
      <tr>
        <th style="width:22px">No</th><th>Nama</th><th>NIK</th><th>L/P</th><th>TTL</th>
        <th>Agama</th><th>Pendidikan</th><th>Pekerjaan</th><th>Hubungan</th>
      </tr>
    </thead>
    <tbody>
  ...
  <div class="footer">
    <div style="font-size:7pt;color:#555">Dicetak: {{ now()->format('d/m/Y H:i') }}</div>
    <div class="ttd">
