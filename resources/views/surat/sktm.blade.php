...
<p class="body-text">Yang bertanda tangan di bawah ini, Kepala Dukuh Gondang, menerangkan dengan sesungguhnya bahwa:</p>
...
<table class="data">
  ...
  <tr><td>Nama Ayah</td><td>:</td><td>{{ $resident->father_name ?? '-' }}</td></tr>
  <tr><td>Nama Ibu</td><td>:</td><td>{{ $resident->mother_name ?? '-' }}</td></tr>
</table>

<p class="body-text">Adalah benar warga tidak mampu yang berdomisili di wilayah Padukuhan Gondang. Berdasarkan pengamatan dan keterangan dari masyarakat setempat, yang bersangkutan tergolong keluarga tidak mampu secara ekonomi.</p>

<p class="body-text">Surat keterangan ini dibuat untuk keperluan: <strong>{{ $keperluan }}</strong></p>

<p class="body-text">Demikian surat keterangan ini dibuat dengan sebenar-benarnya agar dapat digunakan sebagaimana mestinya.</p>
